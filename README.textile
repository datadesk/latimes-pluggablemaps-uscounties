...
<blink>Beware. This software is alpha and has not yet been widely tested.</blink>

h2. Features

* A ready-to-serve model with all the counties in the United States
* A read-only admin for reviewing the data
* Demonstration pages that show how the counties can be displayed with common browser-based mapping libraries.
